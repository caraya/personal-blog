...
`getRoot()` returns the root of the site's API. I've added this function for completeness's sake. Most of the time we'll skip this and look at `getIndex()` instead.
