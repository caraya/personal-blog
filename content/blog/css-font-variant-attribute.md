...
**Note:** Currently, `font-variant-alternate`only works in Firefox and Safari (desktop and iOS/iPadOS) Chromium browsers have equivalent support under `font-feature-settings`.
