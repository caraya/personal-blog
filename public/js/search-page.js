  ...
  `; }
    ...
    render() {
      ...
      <div class="search-box">
        <form @submit=${this._handleSearchSubmit.bind(this)}>
      ...
      ${this._results.length > 0 ? html `
        <div class="pagination">
          <button @click=${this._handlePrevPage.bind(this)} ?disabled=${!hasPrevPage}>
            &larr; Previous
          </button>
          <span class="page-info">
            Page ${currentPage}
          </span>
          <button @click=${this._handleNextPage.bind(this)} ?disabled=${!hasNextPage}>
            Next &rarr;
          </button>
        </div>
      ` : ''}
